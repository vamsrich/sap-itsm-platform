...
async function main() {
  ...
  const supportType = existingST || await prisma.supportTypeMaster.create({
    data: {
      ...
      workDays: [1,2,3,4,5,6], hoursPerDay: 10,
      postBusinessHours: 'ON_CALL', weekendCoverage: 'ON_CALL', holidayCoverage: 'NONE',
      slaPauseConditions: ['PENDING_CUSTOMER', 'OUTSIDE_BUSINESS_HOURS'],
      priorityScope: ['P1','P2','P3','P4'],
      isActive: true,
    },
  });
  ...
  const customer = await prisma.customer.create({
    data: {
      ...
      primaryEmail: 'it.admin@globalmanufacturing.de',
    },
  });
  ...
  const contract = await prisma.contract.create({
    data: {
      ...
      slaConfig: { P1: { response: 30, resolution: 240 }, P2: { response: 60, resolution: 480 }, P3: { response: 240, resolution: 1440 }, P4: { response: 480, resolution: 2880 } },
